...
import { TEST_GITHUB_REPOSITORY, TEST_GITHUB_SHA } from '../constants.js'
...
export function getInputs() {
  if (process.env.IS_LOCAL_DEV === 'true') {
    ...
    process.env.GITHUB_REPOSITORY = TEST_GITHUB_REPOSITORY
    process.env.GITHUB_SHA = TEST_GITHUB_SHA
  ...
  return {
    ...
    s3IndexFileKey: core.getInput('S3_INDEX_FILE_KEY'),
